...
export default function FloodModulePage() {
  return (
    <>
      <DashboardHeader />
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm">
                  <span className="font-semibold text-gray-900">Flood</span>{' '}
          ...
          <Section title="1. Drill Game (Simulation)">
            <div className="space-y-2">
              <div className="relative aspect-[16/9] w-3xl overflow-hidden rounded-lg group mx-auto">
                ...
                <Link
                  href="/student/dashboard/flood/drill"
                  prefetch
              ...
              <p className="text-xs text-gray-500 text-center">
                Practice safe moves during floods — interactive and guided.
              </p>
            </div>
          </Section>
            ...
            <div className="space-y-4">
              <div className="rounded-lg border border-gray-200 p-4 bg-gray-50">
                <p className="text-sm text-gray-700">
                  <span className="font-semibold">Example:</span> “Arrange steps to evacuate to higher ground and secure essentials before flooding.”
                </p>
              </div>
              <div className="flex flex-wrap items-center gap-3">
                <Link href="/student/dashboard/flood/assignment" className="inline-flex items-center gap-2 rounded-md bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium px-4 py-2 shadow-sm" prefetch>
            ...
            <div className="space-y-3">
              <Accordion label="FAQs ▾ (expand to view)">
                <ul className="list-disc pl-5 space-y-1">
                  <li>What should I do when a flood warning is issued?</li>
                  <li>How do I prepare a go-bag for flood evacuation?</li>
                  <li>How to avoid electrical hazards during floods?</li>
                </ul>
              </Accordion>

              <Accordion label="Videos ▾ (expand to view)">
                <ul className="list-disc pl-5 space-y-1">
                  <li><a className="text-blue-700 hover:underline" href="#">Moving to Higher Ground</a></li>
                  <li><a className="text-blue-700 hover:underline" href="#">Shutting Off Utilities Safely</a></li>
                  <li><a className="text-blue-700 hover:underline" href="#">Community Flood Drills</a></li>
                </ul>
              </Accordion>

              <Accordion label="PDFs ▾ (expand to view)">
                <ul className="list-disc pl-5 space-y-1">
                  <li><a className="text-blue-700 hover:underline" href="#">Flood Preparedness Checklist (PDF)</a></li>
                  <li><a className="text-blue-700 hover:underline" href="#">Evacuation Route Planning (PDF)</a></li>
                </ul>
              </Accordion>
            </div>
          </Section>
