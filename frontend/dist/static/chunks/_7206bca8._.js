        ...
        "StudentDashboard.useEffect": ()=>{
            ...
            if (user) {
                ...
                const timeoutId = setTimeout({
                    "StudentDashboard.useEffect.timeoutId": ()=>{
                        getUserProfile().then({
                            "StudentDashboard.useEffect.timeoutId": (profileData)=>{
                        ...
                        }["StudentDashboard.useEffect.timeoutId"]).catch({
                            "StudentDashboard.useEffect.timeoutId": (error)=>{
                ...
                }["StudentDashboard.useEffect.timeoutId"], 300); // Small delay to prevent rapid consecutive calls
...
//# sourceMappingURL=_7206bca8._.js.map