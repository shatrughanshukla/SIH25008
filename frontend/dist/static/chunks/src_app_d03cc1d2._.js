...
const AuthProvider = (param)=>{
    ...
    const getApiBaseUrl = ()=>{
        ...
        if (typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] !== 'undefined' && ("TURBOPACK compile-time value", "http://localhost:5000")) {
    ...
    const refreshToken = async ()=>{
        try {
            ...
            const response = await fetch("".concat(getApiBaseUrl(), "/api/auth/refresh"), {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    const getUserProfile = async ()=>{
        try {
            ...
            // Determine API URL
            const apiUrl = "".concat(getApiBaseUrl(), "/api/users/profile");
...
//# sourceMappingURL=src_app_d03cc1d2._.js.map